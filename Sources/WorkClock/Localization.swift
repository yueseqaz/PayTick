...
enum L10n {
    static let english: [String: String] = [
        ...
        "menuBarShortWeekend": "Off",
        "menuBarShortBeforeWork": "Soon",
        "menuBarShortAfterWork": "Done",
        ...
        "attendanceClearDay": "Clear this day",
        ...
        "notifPreLunchBody": "%d min until break — time to decide what to eat",
        "notifLunchTitle": "Lunch time",
        "notifLunchBody": "Go eat, go rest — don't skip lunch",
        "notifAfternoonTitle": "Afternoon",
        "notifAfternoonBody": "Break's over — back at it, you got this",
    ...
    static let chineseSimplified: [String: String] = [
        ...
        "menuBarShortWeekend": "周末",
        "menuBarShortBeforeWork": "未上班",
        "menuBarShortAfterWork": "已下班",
        "periodMorning": "上午",
        "periodAfternoon": "下午",
        "statusWork": "出勤",
        "statusOvertime": "加班",
        ...
        "notifPreLunchTitle": "快午休啦",
        "notifPreLunchBody": "还有 %d 分钟午休，该想想中午吃啥了～",
        "notifLunchTitle": "午休时间到",
        "notifLunchBody": "去吃饭去休息，别亏待自己的胃呀",
        "notifAfternoonTitle": "下午好",
        "notifAfternoonBody": "午休结束啦，继续冲鸭",
